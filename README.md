...
- The RS485-part, i.e. pins 6+7+8 (GND+RS485-A+RS485-B), connects to the **slave's CAN-port** (more specific: the RS485-part of it), i.e. pins 1+2+3 (GND+RS485-A+RS485-B) and is then **daisy chained** to all subsequent **slave's CAN-ports** (more specific: the RS485-part of it).
